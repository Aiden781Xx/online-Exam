...
const Result = () => {
  return (
    <>
      <div className='view'>
        <h1 className='text-center mt-5 font-bold capitalize text-3xl'>View Result</h1>
              ...
              <div className="mb-1">
               ...
               <div className="mb-2">
                ...
                <div className='Button-view'>
                    <Link to='/show-result'>
                    <Button className='!bg-blue-400 !text-black !px-4 !py-2 !rounded !mr-5 hover:!bg-zinc-300'>View result</Button>
                    </Link>
                </div>
              </div>
